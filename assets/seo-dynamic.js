...
(function(){
  function updateForTeam(abbr, city){
    if(!abbr) return;
    try{
      var newTitle = abbr + ' Universe — Vector Gridiron · 12,966 seasons as sky';
      ...
      if(ogu) ogu.setAttribute('content', 'https://gridiron.dumbmodel.com/?team='+abbr+'&utm_source=share');
      var can = document.querySelector('link[rel="canonical"]');
      if(can) can.setAttribute('href', 'https://gridiron.dumbmodel.com/?team='+abbr);
    }catch(e){}
  }
  function init(){
    ...
    try{
      var ld = {
        ...
        "url":"https://gridiron.dumbmodel.com",
