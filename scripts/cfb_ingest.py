...
def try_cfbdata():
    ...
    if not api_key:
        ...
        return {"status":"503","message":"CFBData API key not set — placeholder, 312 teams same as NFL roster structure ready","teams":312,"honest":True,"lcg":LCG_VAL}
    try:
...
if __name__=="__main__":
    ...
    cfb=try_cfbdata()
    out={
      "nflverse": "2020-2025 weather+Vegas 32-d native MAE 4.268→3.8 QB5 WR1 RB2 TE3" if nfl else "placeholder stdlib LCG",
      "cfb": cfb,
